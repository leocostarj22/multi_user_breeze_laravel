                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="book" {{ old('type') == 'book' ? 'selected' : '' }}>Livro Físico</option>
                            <option value="ebook" {{ old('type') == 'ebook' ? 'selected' : '' }}>E-book</option>
                            <option value="audiobook" {{ old('type') == 'audiobook' ? 'selected' : '' }}>Audiobook</option>
                            <option value="stationery" {{ old('type') == 'stationery' ? 'selected' : '' }}>Papelaria</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
